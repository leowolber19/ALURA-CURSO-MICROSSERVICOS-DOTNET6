...
public class RestauranteController : ControllerBase
{
    ...
    private IItemServiceHttpClient.IItemServiceHttpClient _itemServiceHttpClient;

    public RestauranteController(
        IRestauranteRepository repository,
        IMapper mapper, IItemServiceHttpClient.IItemServiceHttpClient itemServiceHttpClient, IRabbitMqClient rabbitMqClient)
    {
